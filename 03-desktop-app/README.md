...
A pasta inclui `desktop_launcher.py` e `build_windows.bat`. Em um computador de desenvolvimento Windows com Python 3.12, execute `build_windows.bat`. O resultado em `dist\RH_Valoracao\RH_Valoracao.exe` e uma aplicacao empacotada: o usuario final nao precisa instalar Python.
